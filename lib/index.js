...
Parser = function Parser(options) {
  ...
  this._ = {
    ...
    rawBuf: '',
    buf: '',
    rowDelimiterLength: this.options.rowDelimiter ? Math.max(Math, _toConsumableArray(this.options.rowDelimiter.map(function (v) {
      return v.length;
    }))) : void 0
  };
  return this;
...
Parser.prototype.__push = function (line) {
  ...
  if (this.options.columns === true) {
    ...
    err = _call_column_udf[0];
    columns = _call_column_udf[1];
